...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    support: [
      ...
      { name: 'Email: support@tempesttouch.com', href: 'mailto:support@tempesttouch.com' },
      { name: 'Phone: +1-888-526-4640', href: 'tel:+18885264640' },
      { name: 'GitHub', href: 'https://github.com/tempesttouch/tempesttouch' },
    ...
    social: [
      ...
      {
        name: 'LinkedIn',
        href: 'https://www.linkedin.com/company/tempesttouch',
        icon: (
          <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-4 md:mt-0 flex items-center space-x-4">
              ...
              <Link href="/escrow">
                <img
                  ...
                  alt="Escrow Services by tempesttouch.com"
                  className="h-16"
                />
              </Link>
            </div>
