...
import { cashAddrToLegacy as bchCashAddrToLegacy } from '@/lib/bitcoin/bch-address';
...
export function getRpcUrl(chain: BlockchainType): string {
  const urls: Record<BlockchainType, string> = {
    ...
    SOL: process.env.SOLANA_RPC_URL || 'https://go.getblock.io/your-solana-access-token/sol/mainnet',
    ...
    USDT: process.env.ETHEREUM_RPC_URL || 'https://go.getblock.io/your-ethereum-access-token/eth/mainnet',
    USDT_ETH: process.env.ETHEREUM_RPC_URL || 'https://go.getblock.io/your-ethereum-access-token/eth/mainnet',
    USDT_POL: process.env.POLYGON_RPC_URL || 'https://go.getblock.io/your-polygon-access-token/polygon/mainnet',
    USDT_SOL: process.env.SOLANA_RPC_URL || 'https://go.getblock.io/your-solana-access-token/sol/mainnet',
    USDC: process.env.ETHEREUM_RPC_URL || 'https://go.getblock.io/your-ethereum-access-token/eth/mainnet',
    USDC_ETH: process.env.ETHEREUM_RPC_URL || 'https://go.getblock.io/your-ethereum-access-token/eth/mainnet',
    USDC_POL: process.env.POLYGON_RPC_URL || 'https://go.getblock.io/your-polygon-access-token/polygon/mainnet',
