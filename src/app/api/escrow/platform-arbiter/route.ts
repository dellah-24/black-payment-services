...
function getSystemMnemonic(chain: string): string | undefined {
  // Try exact chain first (e.g. SYSTEM_MNEMONIC_USDC_ETH), then fall back to tempesttouch_MNEMONIC
  return (
 ...
 *
 * Returns Tempest Touch's platform arbiter public key for the given chain.
