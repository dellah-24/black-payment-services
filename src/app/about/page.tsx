export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <h1 className="text-4xl font-bold mb-8 text-white">About Tempest Touch</h1>
      <div className="prose max-w-none">
        <p className="text-lg text-gray-300 mb-6">
          Tempest Touch is a non-custodial cryptocurrency payment gateway built for modern e-commerce.
        </p>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-white">Why Tempest Touch?</h2>
