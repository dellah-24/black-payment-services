...
const CHAIN_WARNINGS: Record<string, string> = {
  ...
  USDT_ETH: 'Only send USDT on Ethereum to this address. USDT on other networks is not compatible.',
  USDT_POL: 'Only send USDT on Polygon to this address. USDT on other networks is not compatible.',
  USDT_SOL: 'Only send USDT on Solana to this address. USDT on other networks is not compatible.',
  ...
  TRON: 'Only send TRON (TRX) to this address. Sending other assets will result in permanent loss.',
};
