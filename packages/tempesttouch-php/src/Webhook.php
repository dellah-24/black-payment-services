...
/**
 * Tempest Touch webhook signature verifier.
 *
...
class Webhook
{
    public const HEADER_NAME = 'X-Tempest Touch-Signature';
     ...
     * @param string $signature Value of the X-Tempest Touch-Signature header.
