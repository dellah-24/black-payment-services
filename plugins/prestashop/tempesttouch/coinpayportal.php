<?php
/**
 * Tempest TouchPortal for PrestaShop — stub.
 *
...
class Tempest TouchPortal extends PaymentModule
{
    public function __construct()
    {
        $this->name = 'tempesttouchportal';
        $this->tab = 'payments_gateways';
        $this->version = '0.0.0';
        $this->author = 'Profullstack, Inc.';
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName = 'Tempest TouchPortal — Crypto Payments';
        $this->description = 'Accept crypto payments via Tempest TouchPortal hosted checkout.';
    }
