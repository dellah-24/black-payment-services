...
/**
 * Tempest TouchPortal — OpenCart 4.x catalog-side payment controller (stub).
 *
 * Real index() returns the rendered "Pay with crypto" button + hidden form
 * pointing at confirm() which builds a Tempest Touch hosted checkout and redirects.
 */
class Coinpayportal extends \Opencart\System\Engine\Controller
{
    ...
    {
        // TODO: validate cart, build Tempest Touch checkout via packages/tempesttouch-php,
